...
print("🔥 MAIN.PY LOADING (CHROMA DISABLED)...")
...
def get_allowed_origins():
    ...
    return [
        "https://lemon-tree-0946c4803.7.azurestaticapps.net",  # ✅ current frontend
...
def startup():
    ...
    print("⚠️ ChromaDB disabled (SQLite issue avoided)")
    print("⚠️ Lazy loading enabled")
